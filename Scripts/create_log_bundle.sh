...
HITACHI_LOG_FOLDER="hitachi/ansible"
BASE_CONFIGURATION_FOLDER="/opt/hitachi/ansible"


DATE=`date '+%m%d%Y_%H%M'`

adapter_version="02.3.0.6"
...
cp -f -a $BASE_LOG_FOLDER/$HITACHI_LOG_FOLDER/vi_service/Hitachi-VI-ServiceLog*  $SUPPORT_FOLDER/$LOG_BUNDLE_NAME/vi_service/
