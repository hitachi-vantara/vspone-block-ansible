...
# else
  	/usr/bin/rpm -Uvh HV_Storage_Ansible-02.3.0.6-1.el7.x86_64.rpm 
# fi
...
if [[ "$doAnsibleModule" -eq 1 ]]; then	
	...
	ansible-galaxy collection install hitachi-storage-2.3.0.6.tar.gz -p ~/.ansible/collections --force
