...
Ansible_ROOT=$(pwd)
Ansible_VER=HV_Storage_Ansible-02.3.0.1
...
cp -f ${Ansible_ROOT}/collections/ansible_collections/hitachi/storage/hitachi-storage-2.3.0.1.tar.gz ${Ansible_ROOT}/HV_Storage_Ansible
