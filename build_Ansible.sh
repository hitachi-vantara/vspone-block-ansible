...
# Autogenerated
Ansible_VER=HV_Storage_Ansible-2.3.0-7

HITACHI_STORAGE="${Ansible_VER/HPE_Storage_Ansible/hitachi-storage}.tar.gz"
...
cp -f ${Ansible_ROOT}/collections/ansible_collections/hitachi/storage/${HITACHI_STORAGE} ${Ansible_ROOT}/HV_Storage_Ansible
