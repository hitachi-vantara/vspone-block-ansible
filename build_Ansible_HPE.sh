...
Ansible_ROOT=$(pwd)
Ansible_VER=HPE_Storage_Ansible-2.3.1
...
cp -f ${Ansible_ROOT}/collections/ansible_collections/hpe/xp_storage/hpe-xp_storage-2.3.1.tar.gz ${Ansible_ROOT}/HPE_Storage_Ansible
cd $Ansible_ROOT
