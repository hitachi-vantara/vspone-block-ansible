...
def runPlaybook(module):
    ...
    ucpadvisor_username = ucp_advisor_info.get('username')
    ucpadvisor_password = ucp_advisor_info.get('password')
    ...
    logger.writeParam('ucpadvisor_username={}', ucpadvisor_username)
