# Hitachi Virtual Storage Platform One Block Storage Modules for Red Hat® Ansible® 4.8.1
...
If you need to install a specific version of the collection (for example, to downgrade due to issues in the latest version), you can use the following syntax to install version 4.8.1:

```bash
ansible-galaxy collection install hitachivantara.vspone_block:==4.8.1
```
