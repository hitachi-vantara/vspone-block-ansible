# Hitachi Virtual Storage Platform One Block Storage Modules for Red Hat® Ansible® 4.8.3
...
| VSP One Block High End | A0-05-41-00_01 SVOS 10.5.3 |
...
- Ansible Core: >= 2.16.0 (See meta/runtime.yml for details).
...
If you need to install a specific version of the collection (for example, to downgrade due to issues in the latest version), you can use the following syntax to install version 4.8.3:

```bash
ansible-galaxy collection install hitachivantara.vspone_block:==4.8.3
```
  ...
  tasks:
    ...
    - name: Debug the result variable
      ansible.builtin.debug:
        var: result
```
## Links of Hitachi Vantara Solution playbook repos

For examples of how this collection can be used visit the following repositories:

- [GitHub Repo](https://github.com/hitachi-vantara/hv-playbooks-vspone-block)

- [GitHub Repo](https://github.com/hitachi-vantara/hv-playbooks-dataprotection)

- [GitHub Repo](https://github.com/hitachi-vantara/hv-playbooks-sap)
...
*This collection was created by the Hitachi Vantara® Ansible Team in 2026.*
