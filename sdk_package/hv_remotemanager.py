...
class RemoteManager():
    ...
    def formatPair(self, pair):
        ...
        if pair.get("Fence_Level") is not None:
            pair["Fence_Level"] = FENCE_LEVEL.fromValue(pair.get("Fence_Level", 0)).name
            if pair["Fence_Level"] == "UNKNOWN":
                pair["Fence_Level"] = "NEVER"
    ...
    def formatPairTC(self, pair):
        ...
        if pair.get("Serial") is not None:
    ...
    def getTCPairsFromAll( self, rclist, lun ):
        if lun is None or lun == -1:
            ...
            pairs = [self.formatPairTC(pair) for pair in rclist if pair["Type"] == 5 and str(pair["PVol"]) == str(lun)]
        return pairs
    ...
    def getURPairsFromAll( self, rclist, lun ):
        if lun is None or lun == -1:
            ...
            pairs = [self.formatPairUR(pair) for pair in rclist if pair["Type"] == 6 and str(pair["PVol"]) == str(lun)]
        return pairs

    def getURPairByPVol( self, lun, remote_serial, target_lun):
        ...
        rclist= obj
        pair = [pair for pair in rclist
          if str(pair["Type"]) == str(6) and
          str(pair["PVol"]) == str(lun) and
          (
          str(pair["SVolSerial"]) == str(remote_serial) or
          str(pair["SVolSerial"]) == str(0)
          )
          ]
    ...
    def getURPair( self, lun, remote_serial, target_lun):
        ...
        pair = [pair for pair in rclist
          ...
          str(pair["SVol"]) == str(target_lun)
          ]
        return pair[0]

    def getRemoteClone(self, lun, remote_serial, target_lun):
        ...
        response = requests.get(url, json=body, verify=self.shouldVerifySslCertification)
    ...
    def getTrueCopyPair(self, lun, remote_serial, target_lun):
    ...
    def getTCPairs(self, lun=-1, remote_serial=None, target_lun=None):
        ...
        response = requests.post(url, params=body, verify=self.shouldVerifySslCertification)
    ...
    def getTrueCopyPairsList(self, lun=-1, remote_serial=None, target_lun=None):
...
#             pairs = (response.json())
    ...
    def getRemoteClones(self, lun, remote_serial, target_lun):
    ...
    def createUR(self, lun, remote_serial, target_lun, ctgId=None, allocateCtg=False, copyPace=3,
        enable_delta_resync=False, lun_journal_id=None, target_lun_journal_id=None):
    ...
    def createUR_tpi(self, lun, remote_serial, target_pool_id, ctgId=None, allocateCtg=False, copyPace=3,
        enable_delta_resync=False, lun_journal_id=None, target_lun_journal_id=None):
    ...
    def createTC(self, lun, remote_serial, target_lun, fence_level, ctgId=None, allocateCtg=False, copyPace=3):
    ...
    def createTC_tpi(self, lun, remote_serial, target_pool_id, fence_level, ctgId=None, allocateCtg=False, copyPace=3):
    ...
    def splitTC(self, lun, remote_serial, target_lun, enable_read_write):
    ...
    def splitUR(self, lun, remote_serial, target_lun, enable_read_write):
    ...
    def splitRemoteClone(self, lun, remote_serial, target_lun):
    ...
    def resyncRemoteClone(self, lun, remote_serial, target_lun):
    ...
    def resyncTC(self, lun, remote_serial, target_lun, copy_pace):
    ...
    def resyncUR(self, lun, remote_serial, target_lun, copy_pace):
    ...
    def restoreRemoteClone(self, lun, remote_serial, target_lun):
    ...
    def createGADPairVbox(self, pVol, remote_serial, targetResourceId, quorum_id, targetPoolId, targetHostGroup, allocateCtg):
...
#         Logger().writeInfo(json.dumps(body))
    ...
    def createGADPairVboxCtgid(self, pVol, remote_serial, targetResourceId, quorum_id, targetPoolId, targetHostGroup, ctgID):
...
#         Logger().writeInfo(json.dumps(body))
    ...
    def createGADPair(self, pVol, remote_serial, sVol, quorum_id, ctgID):
...
#         Logger().writeInfo(json.dumps(body))
    ...
    def createGADPair_tpid(self, pVol, remote_serial, target_pool_id, quorum_id, ctgID):
...
#         Logger().writeInfo("ENTER getGADPairs, pVol={}", pVol)
    ...
    def deleteTCPair(self, lun, remote_serial, target_lun):
    ...
    def deleteURPair(self, lun, remote_serial, target_lun):
    ...
    #deleteUR
    def deleteRemoteClone(self, lun, remote_serial, target_lun):
