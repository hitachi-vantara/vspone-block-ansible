...
Source0:       HV_Storage_Ansible-02.1.0.tar.gz        
BuildArch:     x86_64
...
%define vro_root_dir /opt/hitachi

%define ansible_dir ansible
%define vro_sub_dir %{vro_root_dir}/%{ansible_dir}


%install
rm -rf $RPM_BUILD_ROOT
install -d $RPM_BUILD_ROOT/
install -d $RPM_BUILD_ROOT/opt/hitachi/ansible
install -d $RPM_BUILD_ROOT/opt/hitachi/ansible/support
install -d $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services
install -d $RPM_BUILD_ROOT/opt/hitachi/ansible/vi_service
#install -d $RPM_BUILD_ROOT/opt/hitachi/ansible/module_utils
install -d $RPM_BUILD_ROOT/opt/hitachi/ansible/playbooks
#install -d $RPM_BUILD_ROOT/opt/hitachi/ansible/modules
#install -d $RPM_BUILD_ROOT/opt/hitachi/ansible/playbooks/block
...
install -d $RPM_BUILD_ROOT%{vro_root_dir}
...
install -d $RPM_BUILD_ROOT%{vro_root_dir}/ansible
...
install -m 755 /root/rpmbuild/open_firewall_ports.sh $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services
#install -m 755 /root/rpmbuild/60EB41E9-71D5-4D5C-85E9-7E0BB76698ED.rpm  $RPM_BUILD_ROOT/opt/hitachi

# Copy the whole previous directory
#cp -f -a %{previous_sub_dir} $RPM_BUILD_ROOT%{vro_root_dir}
...
#cp -f -a /root/rpmbuild/ansible/playbooks/file/*  $RPM_BUILD_ROOT/opt/hitachi/ansible/playbooks/file
#cp -f -a /root/rpmbuild/ansible/modules/block/* $RPM_BUILD_ROOT/opt/hitachi/ansible/modules/block
#cp -f -a /root/rpmbuild/ansible/modules/file/*  $RPM_BUILD_ROOT/opt/hitachi/ansible/modules/file
...
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/vi_service/VIService-ApacheLicense/lib/javalang-compiler-2.2.12.jar
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/vi_service/VIService-ApacheLicense/lib/merger-1.0.1.jar
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/vi_service/VIService-ApacheLicense/lib/model-checker-1.1.jar
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/vi_service/VIService-ApacheLicense/lib/walkmod-core-2.3.3.jar
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/vi_service/VIService-ApacheLicense/lib/walkmod-javalang-plugin-2.6.10.jar
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/vi_service/VIService-ApacheLicense/lib/javalang-4.7.9.jar

rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/Configuration/hilogger-hpe.config
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/Configuration/ucpsettings.json
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/vro_service_restart.sh
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/vro_service_start.sh
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/vro_service_stop.sh
rm -rf $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/hpeAppsettings.json
...
chmod 755 $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/hv-infra-gateway_service_start.sh
chmod 755 $RPM_BUILD_ROOT/opt/hitachi/ansible/storage_management_services/hv-infra-gateway_service_stop.sh
...
%{vro_root_dir}/*
/opt/hitachi/ansible/
/opt/hitachi/ansible/storage_management_services/
...
/opt/hitachi/ansible/vi_service/
/opt/hitachi/60EB41E9-71D5-4D5C-85E9-7E0BB76698ED.rpm

%post
# chmod 755 -R %{vro_root_dir}

#disable firewall on http, https ports from appsettings.json and 8444
/opt/hitachi/ansible/storage_management_services/open_firewall_ports.sh
...
if [[ -d %{vro_root_dir}/utils/.modules ]]; then
    cp -f --no-dereference --preserve=links %{vro_root_dir}/utils/.modules/* %{vro_root_dir}
fi
