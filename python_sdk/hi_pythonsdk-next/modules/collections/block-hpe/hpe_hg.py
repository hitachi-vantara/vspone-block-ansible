...
short_description: This module manages host group on HPE XP Storage System.
description:
     - The M(hpe_hg) module provides the following host group management operations
     - 1. create host group.
     - 2. delete host group.
...
-
  ...
  gather_facts: false
  vars:
    - host_group_name: sananda-ansible-hg-111
    - luns:
      - 859
      - 847
    - storage_serial: 12345
...
import ansible_collections.hpe.xp_storage.plugins.module_utils.hv_hg_runner as runner
