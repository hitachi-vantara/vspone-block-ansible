    ...
    if len(hostGroups) == 0:
        ...
        if state != 'absent':
            ...
            if not ports:
                ...
                for port in ports:
                    ...
                    writeNameValue('type(hostoptlist)={}',
                                   type(hostoptlist))
                    writeNameValue('hostoptlist is not None and hostmode is not None = {}', hostoptlist is not None
                                   and hostmodename is not None)
                    ...
                    #     writeNameValue('hostoptlist={}', hostoptlist)
                    #     storageSystem.setHostMode(hgName, port,
                    #                               hostmode, hostoptlist)
        ...
        for hgPort in portsToUpdate:
            ...
            if luns:  # If luns is present, present or overwrite luns
                ...
                writeNameValue('delLun={0}', delLun)
                if subobjState == 'present':
