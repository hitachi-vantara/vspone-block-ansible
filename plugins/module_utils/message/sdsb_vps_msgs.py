...
class SDSBVpsValidationMsg(Enum):
    ...
    INVALID_NUMBER_OF_SERVERS = "The value of upper_limit_for_number_of_servers should be between 0 and 1024."

    SAME_SAVING_SETTING = "VPS volume ADR setting is same as the one specified in the spec."
