...
class SDSBVolValidationMsg(Enum):
    ...
    SAVING_SETTING = "This module only accepts Disabled or Compression for capacity_saving field."
    ...
    POOL_OR_VPS_ID = "Either pool_name or vps_name is required ,Specify the parameter correctly."
    QOS_UPPER_LIMIT_IOPS_OUT_OF_RANGE = "upper_limit_for_iops must be -1 or 100 to 2147483647."
    QOS_UPPER_LIMIT_XFER_RATE_OUT_OF_RANGE = "upper_limit_for_transfer_rate_mb_per_sec must be -1 or 1 to 2097151."
    QOS_UPPER_ALERT_ALLOWABLE_TIME_OUT_OF_RANGE = "upper_alert_allowable_time_in_sec must be -1 or 1 to 600."
