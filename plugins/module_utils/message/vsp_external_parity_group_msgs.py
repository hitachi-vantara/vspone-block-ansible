...
class VSPSExternalParityGroupValidateMsg(Enum):
    ...
    PRESENT_STATE_FIELD_MISSING = "For 'present' state, external_path_group_id, port_id, external_wwn, and lun_id are mandatory fields. One or more mandatory fields are missing."
