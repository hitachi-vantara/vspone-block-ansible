...
class SDSBComputeNodeValidationMsg(Enum):
    ...
    ADD_BOTH_IQN_NQN_ERR = "Both iscsi_initiators and host_nqns are provided, you can specify only one type, based on your compute port protocol. Compute node is not created."
