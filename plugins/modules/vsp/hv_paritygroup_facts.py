...
short_description: retrieves information about parity groups from VSP block storage systems.
description:
  - This module gathers facts about parity groups from VSP block storage systems.
