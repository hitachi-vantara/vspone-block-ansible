...
short_description: Retrieves SNMP configuration from VSP block storage systems.
description:
  - This module retrieves SNMP settings (v1, v2c, v3) from VSP block storage systems.
