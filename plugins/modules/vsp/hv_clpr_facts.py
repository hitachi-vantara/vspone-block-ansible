...
short_description: Retrieves information about clprs from VSP block storage systems.
description:
  - This module retrieves information about clprs from VSP block storage systems.
