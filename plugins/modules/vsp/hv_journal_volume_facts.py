    ...
    journal_volume:
      ...
      contains:
        ...
        journal_status:
          ...
          sample: "SMPL"
        ldev_ids:
          description: LDEV IDs of the Journal Volume.
          type: list
          elements: int
          sample:
            - 639
        ldev_ids_hex:
          description: Hexadecimal representation of LDEV IDs.
          type: list
          elements: str
          sample:
            - "00:02:7F"
        mirrors:
          description: Mirror unit information.
          type: list
          elements: dict
          contains:
            active_path_count:
            ...
            is_delta_resync_failure_full_copy:
              description: Whether delta resync failure triggers full copy.
              type: bool
              sample: null
            mirror_unit_id:
        ...
        total_capacity:
          ...
          sample: "9.63 GB"
        type:
          description: Journal volume type.
          type: str
          sample: ""
    warning_deprecated_module:
      description: Deprecation warning message for this module.
      type: str
      returned: always
    user_consent_required:
      description: Message indicating user consent is required for product registration.
      type: str
