    ...
    connection_info:
        ...
        suboptions:
            ...
            connection_type:
                ...
                default: 'direct'
            api_token:
                description: api_token for the gateway connection or value of the lock token to operate on locked resources for direct connection.
                type: str
                required: false
            subscriber_id:
                description:
                - This field is valid for gateway connection type only. This is an optional field and only needed to support multi-tenancy
