...
This changelog includes all new modules that are added to the collection. This also contains all changes to the modules and plugins in this collection that have been made after the previous release.
